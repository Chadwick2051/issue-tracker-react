...
function UserUpdate() {
  ...
  return (
    <div className='container'>
      ...
      <div className="d-flex p-3 bg-secondary text-white rounded-top">
        <div className="d-flex flex-column flex-fill">
          ...
          <div className="p-2 flex-fill"><span><h3>Email</h3><p>{user.email}</p><input></input></span></div>
        </div>
        <div className="d-flex flex-column flex-fill">
          <div className="p-2 flex-fill"><span><h3>Password</h3><p>{user.password}</p><input></input></span></div>
          <div className="p-2 flex-fill"><span><h3>Roles</h3><p>{user.roles}</p><input></input></span></div>
        </div>
        <div className="d-flex flex-column flex-fill">
    ...
    <div className="d-flex flex-column align-self-center flex-fill p-5"><button type="submit" id='btnSubmit' className="btn btn-dark btn-lg btn-block">Update User</button></div>
    </div>
    </div>
  )
}
