...
function BugSummary(props) {
  ...
  return (
    <div className='container'>
      ...
      <div className="d-flex p-3 bg-secondary text-white rounded-top">
        <div className="d-flex flex-column flex-fill">
          <div className="p-2 flex-fill"><span><h3>Title</h3><p>{bug.title}</p><input></input></span></div>
          <div className="p-2 flex-fill"><span><h3>Description</h3><p>{bug.description}</p><input></input></span></div>
          <div className="p-2 flex-fill"><span><h3>Steps to reproduce</h3><p>{bug.steps}</p><input></input></span></div>
        </div>
        <div className="d-flex flex-column flex-fill">
          <div className="p-2 flex-fill"><span><h3>Author</h3><p>{bug.author}</p><input></input></span></div>
          <div className="p-2 flex-fill"><span><h3>Assigned To</h3><p>{bug.assignedTo}</p><input></input></span></div>
          <div className="p-2 flex-fill"><span><h3>classification</h3><p>{bug.classification}</p><input></input></span></div>
        </div>
        <div className="d-flex flex-column flex-fill">
    ...
    <div className="d-flex flex-column align-self-center flex-fill p-5"><button type="submit" id='btnSubmit' className="btn btn-dark btn-lg btn-block">Update Bug</button></div>
    </div>
    </div>
  )
}
